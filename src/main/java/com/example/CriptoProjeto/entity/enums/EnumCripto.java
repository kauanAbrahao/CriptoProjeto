...
public enum EnumCripto {
    ...
    BITCOINGOLD("bitcoin-gold","btg","Bitcoin Gold"),
    ...
    KUCOINSHARES("kucoin-shares","kcs","KuCoin Token"),
    ...
    SAFEMOON("safemoon","safemoon","SafeMoon"),
    ...
    XDCECROWDSALE("xdce-crowd-sale","xdc","XDC Network"),
    YEARNFINANCE("yearn-finance","yfi","yearn.finance"),
